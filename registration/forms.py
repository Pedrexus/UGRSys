...
class SignUpForm(UserCreationForm):
    ...
    department = forms.ModelChoiceField(queryset=Department.objects.all(), empty_label=None, label=_('Departamento'))
    laboratory = forms.ModelChoiceField(queryset=Laboratory.objects.all(), empty_label=None, label=_('Laboratório'))
